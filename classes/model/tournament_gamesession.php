...
/**
 * Class tournament_round
 *
 * @package    mod_challenge\model
 * @copyright  2019 Benedikt Kulmann <b@kulmann.biz>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tournament_gamesession extends abstract_model {
    ...
    /**
     * @var int Timestamp of the creation of this round
     */
    protected $timecreated;
    /**
     * @var int Timestamp of the last db update of this round
     */
    protected $timemodified;
    /**
     * @var int The id of the challenge instance this round belongs to
     */
    protected $game;
    /**
     * @var int The id of the tournament this round belongs to
     */
    protected $tournament;
    /**
     * @var int The id of the moodle user this round belongs to
     */
    protected $mdl_user;
    /**
    ...
    protected $score;
    /**
     * @var int Total number of answers in this round
     */
    protected $answers_total;
    /**
     * @var int Number of correct answers in this round
     */
    protected $answers_correct;
    /**
     * @var string The state of the round, out of [progress, finished, dumped].
     */
    protected $state;
    /**
    ...
    function __construct() {
        parent::__construct('challenge_tnmt_rounds', 0);

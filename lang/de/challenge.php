...
$string['question_count'] = 'Fragen pro Duell';
...
$string['round_matches'] = 'Duelle pro Teilnehmer';
$string['round_matches_help'] = 'Anzahl der Duelle pro Teilnehmer, die über die Dauer einer Spielrunde (s.o.) gleichverteilt generiert werden.';
...
$string['admin_round_stop_confirm'] = 'Möchten Sie die Runde {$a} wirklich vorzeitig beenden? Achtung: Duelle mit unbeantworteten Fragen können nicht gewonnen werden.';
...
$string['admin_users_participants_status_enabled'] = 'Aktiv';
$string['admin_users_participants_status_disabled'] = 'Gesperrt';
...
$string['admin_results_pending'] = 'Duelle und ihre Ergebnisse können erst eingesehen werden wenn die Runde gestartet wurde.';
$string['admin_results_no_matches'] = 'Es gibt für diese Runde bisher keine Duelle, weil es keine aktiven Teilnehmer gibt (siehe Teilnehmer-Verwaltung).';
$string['admin_results_match_group'] = 'Duelle {$a->number} (vom {$a->date} um {$a->time})';
...
$string['game_match_loading'] = 'Duelle werden geladen';
$string['game_match_show_error'] = 'Bei der Anzeige des ausgewählten Duells ist etwas schiefgelaufen.';
$string['game_match_versus'] = 'vs.';
$string['game_match_step'] = 'Runde {$a->step} / {$a->total}';
$string['game_match_lbl_round_open'] = 'offen';
$string['game_match_lbl_round_ended'] = 'beendet';
$string['game_match_title'] = 'Duell {$a->number} (vom {$a->date} um {$a->time})';

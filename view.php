...
/**
 * Prints a particular instance of challenge
 *
...
if ($coursemoduleid > 0) {
    $path = '/mod/challenge/view.php/' . $coursemoduleid . '/';
...
$title = get_string('modulename', 'mod_challenge');
$url = new moodle_url('/mod/challenge/view.php', ['id' => $coursemoduleid]);
...
$PAGE->requires->js_call_amd('mod_challenge/app-lazy','init', [
